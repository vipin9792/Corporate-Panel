...
const UpdateLogo = () => {
  ...
  const [uploadedLogo, setUploadedLogo] = useState(null); // State to store the uploaded logo URL
  ...
  const updateLogo = async () => {
    ...
    try {
      ...
      if (response.data.code === 1000) {
        ...
        // Assuming the response contains the URL of the updated logo
        setUploadedLogo(base64Image); // Store the updated logo URL or base64 string
      } else {
