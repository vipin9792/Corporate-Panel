                                        ...
                                        <div className="row border-bottom  p-3 align-items-center">
                                            <div className="col-lg-7">
                                                <div className="row">
                                                    <div className="col-lg-12 text-primary ">
                                                        <h4 className="fw-bold">Hackathon Title Name</h4>
                                                        <h6 className="fw-bold">UI/UX Designer</h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-lg-5">
                                                <div className="d-flex align-items-center justify-content-end">
                                                    <a href="#btn"
                                                        className="d-flex align-items-center btn btn-sucess rounded-pill px-3"><img
                                                            src="success-icon.svg" alt=""
                                                            className="img-fluid me-2" width="25"/> Done
                                                    </a>

                                                    <a href="#btn" className="mx-4 ">
                                                        <img src="download.svg" alt="#"
                                                            width="35"/>
                                                    </a>

                                                    <a href="view-result.html" className="d-flex align-items-center btn border-0 rounded-pill px-3 text-primary fw-semibold" target="_blank">View
                                                        Result
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div className="row p-4 align-items-start">
                                            <div className="col-lg-4">
                                                <div className="d-flex align-items-start">
                                                    <div className="flex-child">
                                                        <img src="total-candidate-icon.svg"
                                                            alt="q-pack" className="img-fluid"/>
                                                    </div>
                                                    <div className="flex-child status ps-2">
                                                        <h4 className="fs-6 fw-bold mb-0">Total Candidate</h4>
                                                        <p className="fs-4 fw-bold mb-0">75
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-lg-4">
                                                <div className="d-flex align-items-start justify-content-center">
                                                    <div className="flex-child">
                                                        <img src="passed-icon.svg" alt="q-pack"
                                                            className="img-fluid"/>
                                                    </div>
                                                    <div className="flex-child status ps-2">
                                                        <h4 className="fs-6 fw-bold mb-0">Passed</h4>
                                                        <p className="fs-4 fw-bold mb-0">50
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-lg-4">
                                                <div className="d-flex align-items-start justify-content-end">
                                                    <div className="flex-child">
                                                        <img src="fail-icon.svg" alt="q-pack"
                                                            className="img-fluid"/>
                                                    </div>
                                                    <div className="flex-child status ps-2">
                                                        <h4 className="fs-6 fw-bold mb-0">Fail</h4>
                                                        <p className="fs-4 fw-bold mb-0">25
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="row border-bottom  p-3 align-items-center">
                                            ...
                                            <div className="col-lg-5">
                                                <div className="d-flex align-items-center justify-content-end">
                                                    ...
                                                    <a href="#btn"
                                                        className="d-flex align-items-center btn border-0 rounded-pill px-3 text-primary fw-semibold">View
                                                        Result
                                                    </a>
                                                </div>
                                            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-8 mb-3">
                                <div className="row">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="col-lg-4">
                                            <input type="text" className="text-center bg-light border rounded form-control"
                                                value="Rs. 85"/>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-6 mb-3">
                                <div className="form-floating">
                                    ...
                                    <label for="floatingInput"><span><img src="batch-time.svg" alt="Time"
                                                className="img-fluid"/></span> Time</label>
                                </div>
                            </div>
                            <div className="col-lg-12 mb-3">
                                <h6>Banner Image</h6>
                            ...
                            <div className="col-lg-6 mb-3">
                                <div className="form-floating">
                                    ...
                                    <label for="floatingSelect text-primary ulSelectGen" id="ulSelectGen"><img
                                            src="banner-size.svg" alt="gender"/> Select Banner
                                        Size</label>
                                </div>
                            </div>
                            <div className="col-lg-6  mb-3">
                                <div className="form-floating customUploadButton">
                                    {/* <input className="form-control p-5" type="file" id="formFile" required=""
                                        value="upload"/> */}
                                    <label for="formFile" className="form-label text-dark text-center mb-0">Upload File
                                        <br/><span className="small text-secondary text-center">
                                            Banner Size - 800X400px
                                        </span></label>
                                </div>
                                <span className="fs-smaller ms-2 text-secondary"> Supported Formats PNG, JPEG and file size
                                    max 5mb</span>
                            </div>
                            <div className="col-lg-6 mb-3">
                                <div className="form-floating">
                            ...
                            <div className="col-lg-6 mb-3">
                                <div className="form-floating">
                                    ...
                                    <label for="floatingSelect text-primary ulSelectGen" id="ulSelectGen"><img
                                            src="level.svg" alt="level"/> Level</label>
                                </div>
                            </div>
                            <div className="col-lg-6 mb-3">
                                <div className="form-floating">
                                    ...
                                    <label for="floatingSelect text-primary ulSelectGen" id="ulSelectGen"><img
                                            src="batch-sector.svg" alt="sector"/> Sector</label>
                                </div>
                            </div>
                            <div className="col-lg-6 mb-3">
                                <div className="form-floating">
                                    ...
                                    <label for="floatingSelect text-primary ulSelectGen" id="ulSelectGen"><img
                                            src="language.svg" alt="language"/> Language</label>
                                </div>
                            </div>
                            <div className="col-lg-6 mb-3">
                                <div className="form-floating">
                                    ...
                                    <label for="floatingSelect text-primary ulSelectGen" id="ulSelectGen"><img
                                            src="location.svg" alt="state"/>State</label>
                                </div>
                            </div>
                            <div className="col-lg-6 mb-3">
                                <div className="form-floating">
                                    ...
                                    <label for="floatingSelect text-primary ulSelectGen" id="ulSelectGen"><img
                                            src="town.svg" alt="gender"/> City</label>
                                </div>
                            </div>
                            <div className="col-lg-12  mb-3">
                                ...
                                <div className="row">
                                    <div className="col-lg-6">
                                        <div className="form-floating customUploadButton">
                                            {/* <input className="form-control p-5" type="file" id="formFile" required=""
                                                value="upload"/> */}
                                            <label for="formFile" className="form-label text-dark text-center mb-0">Upload
                                                File <br/><span className="small text-secondary text-center">
                                                    Banner Size - 800X400px
                                                </span></label>
                                        </div>
                                        <span className="fs-smaller ms-2 text-secondary"> Supported Formats PNG, JPEG and
