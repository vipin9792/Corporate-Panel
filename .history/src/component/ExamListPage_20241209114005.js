...
import ExamListPageApi  { fetchExams } from "../Api Folder/ExamListPageApi"; 
import Footer from "./Footer"; // Ensure this exists or replace with your footer component
  ...
  useEffect(() => {
    const getExamsData = async () => {
      try {
        ...
        const data = await fetchExams(corp_id); // Use the fetchExams function here
