...
import { faUserCircle, faSignOutAlt, faUserEdit, faCoffee, faCalendarAlt } from "@fortawesome/free-solid-svg-icons";
...
const ViewProfile = () => {
  ...
  const [uploadedLogo, setUploadedLogo] = useState(null); // To store uploaded logo URL or base64 string
  ...
  const updateLogo = async () => {
    ...
    try {
      ...
      if (response.data.code === 1000) {
        ...
        setUploadedLogo(base64Image); // Update the uploaded logo
      } else {
