    ...
    <Container className="p-5">
      ...
      <Modal id="statusErrorsModal" centered>
        <Modal.Body className="text-center p-lg-4">
          ...
          <p className="mt-3">This email is already registered, please login.</p>
          <Button variant="danger" className="btn-sm mt-3" onClick={() => window.$('#statusErrorsModal').modal('hide')}>
            Ok
          </Button>
        </Modal.Body>
      </Modal>
      ...
      <Modal id="statusSuccessModal" centered>
        <Modal.Body className="text-center p-lg-4">
          ...
          <Button variant="success" className="btn-sm mt-3" onClick={() => window.$('#statusSuccessModal').modal('hide')}>
            Ok
          </Button>
        </Modal.Body>
      </Modal>
