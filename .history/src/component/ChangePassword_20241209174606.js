    ...
    try {
      const response = await fetch(`/api/corp/dashboard/changePassword`, {
        ...
        headers: {
          ...
          "Authorization": `Bearer ${'!WCZVSa3eTg!rE8#0GjAhulUyvOuu!TKB1vz$Y!baEak&u.ZMvikJ3OrjwvcGe91H5@nNY200EkYECpOYRNbu25aipgUGK0Ebi6HuNUDZsV$.MaKIikX6sg!9FaQnJcz'}`, // Pass your Bearer token here
        },
        body: JSON.stringify({
          corp_id,
