    ...
    <div className="profile-dashboard container">
      <div className="card" style={{ width: '18rem', margin: '20px auto', padding: '20px', borderRadius: '10px' }}>
        ...
        <div className="card-body text-center">
          ...
          <p className="card-text"><strong>Email: {profileData?.email} </strong></p>
...
<h5 className="card-title">{profileData?.company_name}</h5>
          <p className="card-text"><strong>Email: {profileData?.email} </strong></p>
          <p className="card-text"><strong>Phone: </strong>{profileData?.email}</p>
          <p className="card-text"><strong>Address: </strong>{profileData?.email}</p>
          <p className="card-text"><strong>Storage Used: </strong>{profileData?.email} MB</p>
          <p className="card-text"><strong>Verification Status: </strong>{profileData?.verify_status === 1 ? 'Verified' : 'Not Verified'}</p>
