...
import { faUser, faBriefcase, faCalendarAlt, faSignOutAlt } from '@fortawesome/free-solid-svg-icons';
              ...
              <ul className="menu-inner py-1 demo" style={{ background: "#1C4481" }}>
                ...
                <li>
                  <Link data-bs-toggle="collapse" data-bs-target="#collapseProfile" aria-expanded="false" aria-controls="collapseProfile" className="d-flex cursor-pointer text-decoration-none">
                    <FontAwesomeIcon icon={faUser} size="2x" className="mx-2" style={{ color: "white" }} />
                    ...
                    plansData.map((plan, index) => (
                      <div className="col-md-4 mb-4" key={index}>
                        <div className="card shadow-lg" style={{ borderRadius: "15px", overflow: "hidden", border: "none" }}>
                          <div className="card-header" style={{ background: "#1C4481", color: "white", borderTopLeftRadius: "15px", borderTopRightRadius: "15px" }}>
