  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log(transactionResponse); // Log the full response to see the structure
  
        // Filter successful transactions
        const successfulTransactions =
          transactionResponse.data.transactions.filter(
            (transaction) => transaction.payment_status === 1
          );
  
        console.log(successfulTransactions); // Log the filtered transactions
