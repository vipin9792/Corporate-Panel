                                        ...
                                        plansData.map((plan, index) => {
                                            ...
                                            return (
                                                <div key={index} className="col-lg-4 mb-2">
                                                    <div className="card shadow-sm" style={{ height: "1250px" }}>
                                                  
                                                        <div className="card-body">
                                                        
                                                   
                                                            <h5 className="card-title bg-primary text-white p-3">{plan.plan_name}</h5><br />
                                                            <FontAwesomeIcon icon={icons.basic}  style={{ fontSize: "50px", marginBottom: "15px" }}/> <br /><br /><br />
                                                            <p className="card-text"><strong>Total Cost :</strong>  {plan.no_of_exam}</p>
                                                            <p><strong >Discount :</strong> {plan.discount}%</p>
                                                            <p><strong >Storage :</strong> {plan.total_storage} GB</p>
                                                            <p><strong >Number of Exams : </strong>{plan.no_of_exam}</p>
                                                            <p className="card-text text-center"><strong >Feature</strong></p>

                                                            <p className="list-unstyled " > 
                  {plan.features.map((feature) => (
                    <div >
                    <p key={feature.id_subscription} style={{textAlign:"center"}} >
