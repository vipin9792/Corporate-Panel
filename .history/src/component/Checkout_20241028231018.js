...
const Checkout = () => {
  ...
  return (
    <div className="plan-manager">
     ...
     <p> <strong className=' text-danger fs-3' style={{marginLeft:"-363px"}}>$2500</strong></p>
     <p className='text-primary' style={{marginBottom:"4px",marginLeft:"-342px"}}>Promo Code</p>
     </div>
      ...
      <p style={{marginLeft:"-293px"}}><strong >Total Price:</strong> $99</p>
