...
import "react-toastify/dist/ReactToastify.css"; // Importing default styles for Toastify
    ...
    try {
      ...
      if (response.status === 200 && response.data.corp_id) {
        ...
        toast.success("Signup successful! Please verify OTP.", {
          position: toast.POSITION.TOP_RIGHT, // Customize position of toast
          autoClose: 5000, // Time after which the toast closes automatically
        });
