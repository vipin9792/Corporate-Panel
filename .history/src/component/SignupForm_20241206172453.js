        ...
        <div className="row credential">
          <div className="col-lg-6 bg-primary text-white bg-icons">
            <div className="imageicon">
              ...
              <img src="pen-scale.svg" alt="pen scale" />
              <img src="boy.svg" alt="boy" />
              <img src="bulb1.svg" alt="bulb" />
                      ...
                      <div className="row">
                        <div className="col-lg-10 mx-auto">
                          <div className="form-floating mb-3">
                            ...
                            <label htmlFor="companyName">
                              <span>
                                <img src="name.svg" alt="company name" />
                              </span>{" "}
                              Company Name
                            </label>
                            <ErrorMessage
                        ...
                        <div className="col-lg-10 mx-auto">
                          <div className="form-floating mb-3">
                            ...
                            <label htmlFor="address">
                              <img src="state.svg" alt="address" /> Address*
                            </label>
                            <ErrorMessage
                              name="address"
                              component="div"
                        ...
                        <div className="col-lg-10 mx-auto">
                          <div className="form-floating mb-3">
                            ...
                            <label htmlFor="userid">
                              <img src="user.svg" alt="user id" /> User ID*
                            </label>
                            <ErrorMessage
                              name="userid"
                              component="div"
                        ...
                        <div className="col-lg-10 mx-auto">
                          <div className="form-floating mb-3 position-relative">
                            ...
                            >
                              {showPassword ? (
                                <img src="eye.png" alt="Show" style={{ width: "20px", height: "20px" }} />
                              ) : (
                                <img src="eye.png" alt="Show" style={{ width: "20px", height: "20px" }} />
                              )}
                            </span>
                        ...
                        <div className="col-lg-10 mx-auto">
                          <div className="form-floating mb-3">
                            ...
                            />
                            <label htmlFor="name">
                              <img src="name.svg" alt="full name" /> Full Name*
                            </label>
                            <ErrorMessage
                              name="name"
                              component="div"
