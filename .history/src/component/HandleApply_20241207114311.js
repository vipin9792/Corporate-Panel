                        ...
                        <aside id="layout-menu" className="layout-menu menu-vertical menu bg-primary" style={{ height: "100vh", zIndex: 1 }}>
                            <div className="app-brand demo" style={{ background: "#1C4481" }}>
                                <a href="index.html" className="app-brand-link">
                                    <img src="logo1.png" alt="dashboard-active" className="img-fluid" style={{ mixBlendMode: "luminosity",opacity:"0.8"}} />
                                </a>
            ...
            <div className="container h-15vh">
              <div className="row mt-3 align-items-center">
                <div className="col-lg-8">
                   <h4 className="fw-bold text-primary">Plan</h4> 
                </div>
...
{/* use code */}
       ...
       {/* <Promo/> */}
       <div className="container  " style={{background:"#f2f2f2",height:"460px",borderRadius:"40px"}}>
        <div className="row">
        <div className="col-md-4 demo_heor " style={{marginLeft:"120px",marginTop:"23px",borderRadius:"25px",width:"350px"}}>
                            <p className='line-height mt-5'><span class="checkmark ">&#10003;</span> 3-5 days turnaround</p>
                            <p className='line-height'><span class="checkmark ">&#10003;</span> Native Development</p>
                            <p className='line-height'><span class="checkmark ">&#10003;</span> Task Deliveerd One-By-One</p>
                            <p className='line-height'><span class="checkmark ">&#10003;</span> Dedicated Dashboard</p>
                            <p className='line-height'><span class="checkmark ">&#10003;</span> Updates via Dashboard & Slack</p>
                              </div>
