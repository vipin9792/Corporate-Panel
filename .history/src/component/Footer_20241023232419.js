...
import { FaPhone, FaMapMarkerAlt, FaClock, FaFacebookF, FaInstagram, FaLinkedinIn } from 'react-icons/fa';
            ...
            <div className="row">
              ...
              <div className="col-md-6 col-lg-4 open-hours">
                ...
                <table className="table">
                  <tbody>
                    <tr>
                      <td><FaClock /> Monday - Thursday</td>
                      <td>9:00am - 5:00pm</td>
                    </tr>
                    <tr>
                      <td><FaClock /> Friday</td>
                      <td>9:00am - 4:00pm</td>
                    </tr>
                    <tr>
                      <td><FaClock /> Saturday</td>
                      <td>9:00am - 1:30pm</td>
                    </tr>
                    <tr>
                      <td><FaClock /> Sunday</td>
