          ...
          <div className="layout-page bg-white h-100vh">
                    ...
                    <div className="col-lg-6">
                      <div className="border rounded-pill p-1 d-flex align-items-center upDashboard">
                        ...
                        <h6 className="ms-2 mb-0 ">
                          ...
                          <a href=""><FontAwesomeIcon icon={faSignOutAlt} style={{ color: "grey", position: "relative", left: "25%", marginBottom: "8px", width: "35px", height: "15px" }} /></a>
                        </h6>
                      </div>
                    </div>
                  </div>
            ...
            <div className="container mt-1">
              <div className="alert alert-danger" role="alert" style={{ background: "#EDF2FF", borderRadius: "10px" }}>
                ...
                <hr />
                <a href="#" className="btn btn-primary text-white">Upgrade Plan</a>
              </div>

              <div className="row">
                {/* Card 1: Students */}
                <div className="col-md-4 mb-4 rounded-lg ">
                  <a href="#" className="card text-center card-light-blue" style={{
                    background: "#4775d1", borderRadius: "22px"
                  }}>
                    <div className="card-body d-flex align-items-center justify-content-between">

                      <div className="flex-grow-1 text-start">
                        <img src="batch.svg" alt="" />
                        <h5 className="card-title my-2  text-white fs-5" style={{ width: "125px" }}>Total Hackathon</h5>
                      </div>
                ...
                <div className="col-md-4 mb-4">
                  <a href="exams.html" className="card text-center card-light-green" style={{
                    background: '#004d4d', borderRadius: "22px"
                    ...
                    <div className="card-body d-flex align-items-center justify-content-between">
                      ...
                      <div className="flex-grow-1 text-start">
                        ...
                        <h5 className="card-title my-2  text-white fs-5" style={{ width: "125px" }}>Free Hackathon</h5>
                      </div>
                      <div className="card-data text-start">
                ...
                {/* Card 3: Batches */}
                <div className="col-md-4 mb-4">
                  <a href="batches.html" className="card text-center card-light-yellow" style={{
                    background: '#d966ff', borderRadius: "22px"
                  }}>
                    <div className="card-body d-flex align-items-center justify-content-between">

                      <div className="flex-grow-1 text-start">
                        <img src="exam.svg" alt="" />
                        <h5 className="card-title my-2  text-white fs-5" style={{ width: "125px" }}>Paid Hackathon</h5>
                      </div>
                      <div className="card-data text-start">
                ...
                <div className="col-md-12 mb-3">
                  <div className="card text-center" style={{
                    ...
                    <div className="card-body" style={{
                      ...
                      <button type="submit" className="btn btn-primary  text-white" style={{ marginTop: "-17px" }}>Assess Assessment Console</button>
                      <p className="card-text  mb-5">Manage users, exams, and settings</p>
