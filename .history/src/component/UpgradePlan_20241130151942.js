      ...
      <div>
        ...
        {plansData.length > 0 ? (
          <div className="plans-container">
            {plansData.map((plans) => (
              <div key={plans.id} className="plan-card">
                <h3>{plans.plan_name}</h3>
                <p><strong>Total Cost:</strong> ${plans.total_cost}</p>
                <p><strong>Discount:</strong> {plans.discount}%</p>
                <p><strong>Time Limit:</strong> {plans.time_limt} minutes</p>
                <p><strong>Total Storage:</strong> {plans.total_storage} GB</p>
                <p><strong>Number of Exams:</strong> {plans.no_of_exam}</p>
