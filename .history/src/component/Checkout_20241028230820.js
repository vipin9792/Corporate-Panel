...
const Checkout = () => {
  ...
  return (
    <div className="plan-manager">
        <div >
     <button className='btn btn-primary' style={{marginLeft:"-113px"}}>Business Plan</button>
     <p> <strong className=' text-danger fs-3' style={{marginLeft:"-123px"}}>$2500</strong></p>
     <p className='text-primary' style={{marginBottom:"4px",marginLeft:"-102px"}}>Promo Code</p>
     </div>
