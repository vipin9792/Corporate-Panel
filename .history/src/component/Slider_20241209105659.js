...
import fetchCarouselData from './SliderApi'; // Import the new SliderApi function
...
const Slider = () => {
  ...
  useEffect(() => {
    const getCarouselData = async () => {
      setLoading(true);
      try {
        const data = await fetchCarouselData(); // Call the new API function
        if (data.code === 1000) {
        ...
        <div className="warapper-form-alert carouselWrapper" style={{ marginTop: "40px" }}>
          <div id="carouselExample" className="carousel slide" data-bs-ride="carousel" style={{ width: '400px', margin: 'auto' }}>
            <div className="carousel-inner">
              {loading ? (
                <div className="carousel-item active">
                  <img src="loading.svg" className="d-block w-100" alt="Loading" />
            ...
            <div className="carousel-buttons text-center mt-3">
              <button className="btn btn-primary btn-sm" type="button" data-bs-target="#carouselExample" data-bs-slide="prev" style={{ marginLeft: "70px" }}>
                <i className="bi bi-chevron-left text-white fs-6"></i>
              </button>
              &nbsp;&nbsp;&nbsp;
              <button className="btn btn-primary btn-sm" type="button" data-bs-target="#carouselExample" data-bs-slide="next" style={{ marginRight: "125px" }}>
