    ...
    const fetchPlansData = async () => {
      try {
        ...
        if (response.data && Array.isArray(response.data)) {
          setPlansData(response.data);  // Only set plansData if it's an array
        } else {
          console.error('Unexpected response format:', response.data);
          alert('Failed to fetch plans data. Invalid response format.');
        }
        setLoading(false);
            ...
            <div className="layout-page bg-white">
              ...
              <div className="container mt-5">
                <div className="row text-center">
                  {Array.isArray(plansData) && plansData.map((plans) => (
                    <div className="col-md-4 mb-4" key={plan.id}>
                      <div className="card" style={{
                        ...
                        <div className="card-body" style={{ padding: "30px" }}>
                          ...
                          <h2 className="card-title">{isYearly ? plans.plan_name : plan.monthlyPrice}</h2>
