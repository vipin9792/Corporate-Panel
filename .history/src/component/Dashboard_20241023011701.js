          ...
          <div className="container mt-1">
            ...
            <div className="row">
              ...
              <div className="col-md-4 mb-4">
                <span href="exams.html" className="card text-center card-light-green" style={{ background: '#004d4d', borderRadius: "22px" }}>
                  <div className="card-body d-flex align-items-center justify-content-between">
                    <div className="flex-grow-1 text-start">
              ...
              <div className="col-md-12 mb-3">
                <div className="card text-center" style={{ background: 'rgba(0, 0, 139, 0.3)' }}>
                  ...
                  <div className="card-body" style={{ background: 'rgba(0, 0, 139, 0.3)' }}>
                    <button type="submit" className="btn btn-danger border-secondary text-bold" style={{ marginTop: "-17px", background: "#1C4481" }}>Assess Assessment Console</button><br />
                    <p className="card-text mb-5 text-white ">Manage users, exams, and settings</p>
                  </div>
                </div>
              
              </div>
              <footer className="bg-primary  h-50 text-center text-white rounded-pill p-3 ">SPWID Copyright © 2021 Inferno - All rights reserved || Designed By: Spiwd</footer>
            </div>
