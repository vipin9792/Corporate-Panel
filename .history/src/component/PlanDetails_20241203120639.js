  ...
  return (
    <>
      ...
      <section className="bg-light ">
        <Container style={{fontSize:"16px",marginLeft:"62px"}}>
          
          <div className="list-unstyled"><span className="fw-b text-success fs-4 ">Features:</span>
            {planData && planData.features ? (
              planData.features.map((feature) => (
                <p key={feature.id_subscription}  >
