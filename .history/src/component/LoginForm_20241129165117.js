...
import Slider from './Slider'; // Assuming Slider is an external component, included here.
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      ...
      if (response.data.code === 1000) {
        ...
        const corpId = response.data.profile.id;  // Get the corp_id from the response
  
        // Navigate to Dashboard with corp_id in the URL
