    ...
    <div className="row text-center">
        {plansData.map(plan => (
            <div className="col-md-4 mb-4" key={plan.name}>
                <div className="card" style={{ background: `linear-gradient(135deg, ${plan.color} 30%, rgba(0, 0, 0, 0.7) 100%)`, border: "none", color: "white", transition: "transform 0.3s, box-shadow 0.3s", boxShadow: "0 4px 20px rgba(0, 0, 0, 0.2)" }}>
                    <div className="card-header" style={{ background: "rgba(0, 0, 0, 0.5)", color: "white" }}>
                        <h3>{plan.name}</h3>
                    </div>
                    ...
                    <div className="card-footer" style={{ background: "rgba(0, 0, 0, 0.5)", color: "white" }}>
