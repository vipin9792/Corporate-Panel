...
import { useNavigate } from "react-router-dom";  // For navigation after successful login or errors
...
const Dashboard = () => {
  ...
  const corpId = 1;  // Hardcoded for this example. You can dynamically set this from context or route params.
    ...
    try {
      ...
      const response = await axios.get(
        `http://103.35.121.219:4000/corp/dashboard/fetchProfile`,
        {
          ...
          params: {
            corp_id: corpId,  // Add corp_id in the params
          },
        }
      );
