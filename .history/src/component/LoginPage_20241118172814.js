...
const LoginPage = ({ onLoginSuccess }) => {
  ...
  // Bearer Token - static token for use after login
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (code === 1000) {
        // On successful login, send the token in the Authorization header
        alert("Login successful!");

        // You can pass the Bearer token to parent component or store it
