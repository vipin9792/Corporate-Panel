...
const SignupForm = () => {
  ...
  const BEARER_TOKEN = process.env.REACT_APP_BEARER_TOKEN || '!WCZVSa3eTg!rE8#0GjAhulUyvOuu!TKB1vz$Y!baEak&u.ZMvikJ3OrjwvcGe91H5@nNY200EkYECpOYRNbu25aipgUGK0Ebi6HuNUDZsV$.MaKIikX6sg!9FaQnJcz';  // Replace with your token or use env variables
  ...
  const initialValues = {
    ...
    passwd: "",
    name: "",
    termsAndConditions: false,  // Added field for terms and conditions
  };
  ...
  const validationSchema = Yup.object({
    ...
    termsAndConditions: Yup.bool()
      ...
      .required("You must accept the terms and conditions"), // Added validation for terms acceptance
  });
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-10 mx-auto">
                          <div className="form-floating mb-3">
                            ...
                            />
                            <label htmlFor="name">
                              <img src="user.svg" alt="" /> Full Name
                            </label>
                            <ErrorMessage
                              name="name"
                              component="div"
                        ...
                        <div className="col-lg-10 mx-auto mt-3">
                          <div className="form-check">
                            ...
                            />
                            <label htmlFor="termsAndConditions" className="form-label fs-6 text-dark">
                              I Accept to the <a href="#terms-and-condition" className="text-dark">Terms &amp; Conditions</a>
                            </label>
