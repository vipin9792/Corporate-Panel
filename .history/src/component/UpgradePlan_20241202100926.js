...
const UpgradePlan1 = () => { 
    ...
    // Fetch subscription plans data from the API
                        ...
                        <div className="layout-page bg-white">
                            ...
                            <div className="container mt-5">
                                <div className="row text-center">
                                    ...
                                    {!loading && !error && plansData.length === 0 && <p>No plans available.</p>}
                                    {!loading && !error && plansData.length > 0 && plansData.map((plan, index) => (
                                        <div key={index} className="col-lg-4 mb-4">
                                            <div className={`card p-3 ${plan.isRecommended ? 'recommended' : ''}`}>
                                                <h4>{plan.plan_name}</h4>
                                                <p>{plan.plan_details}</p>
                                                <h6>{isYearly ? `Annual Price: ${plan.yearly_price}` : `Monthly Price: ${plan.monthly_price}`}</h6>
