                      ...
                      <Card className="shadow-sm mb-4 rounded-3">
                        <Card.Body className="text-center">
                          ...
                          <p>
                            ...
                            {planData ? planData.storage : "10"} GB
                          </p>
                          <p>
                            <strong>Exam Capacity:</strong>{" "}
                    ...
                    {planData && planData.features ? (
                      planData.features.map((feature, index) => (
                        <Col
                          ...
                          md={4}
                          className={`mb-3 ${feature.subscription_display_name === "Viva Examination" ? "order-md-last" : ""} ${index === 2 ? "order-md-2" : ""}`}
                        >
