...
const EmailVerificationFlow = () => {
  ...
  const BEARER_TOKEN = '!WCZVSa3eTg!rE8#0GjAhulUyvOuu!TKB1vz$Y!baEak&u.ZMvikJ3OrjwvcGe91H5@nNY200EkYECpOYRNbu25aipgUGK0Ebi6HuNUDZsV$.MaKIikX6sg!9FaQnJcz';  // Replace with a secure token
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      ...
      if (response.status === 200 && response.data.code === 1000) {
        ...
        navigate('/LOginogin'); // Redirect to login page after OTP verification
      } else {
