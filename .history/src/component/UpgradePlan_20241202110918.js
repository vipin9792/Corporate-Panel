                                        ...
                                        plansData.map((plan, index) => {
                                            ...
                                            return (
                                                <div key={index} className="col-lg-4 mb-4">
                                                    <div className="card shadow-sm" style={{ height: "900px" }}>
                                                        <div className="card-body">
                                                            <h5 className="card-title bg-primary text-white p-4">{plan.plan_name}</h5>
                                                            <p className="card-text">Total Cost:{plan.no_of_exam}</p>
                                                            <p><strong >Discount:</strong> {plan.discount}%</p>
                                                            <p><strong >Storage: {plan.total_storage} GB</p>
                                                            <p><strong >Number of Exams: {plan.no_of_exam}</p>
                                                            <p className="card-text text-center"><strong >Feature</strong></p>

                                                            <ul className="list-unstyled " > 
                  {plan.features.map((feature) => (
                    <div >
                    <li key={feature.id_subscription} style={{textAlign:"center"}}>
