                        ...
                        <div class="position-relative h-100 skyblue rounded p-3 mt-3">
                            <div class="hackthonProfile overflow-auto pe-2 h-100">
                                <div class=" bg-white">
                                    <div class="row m-1">
                                        <div
                                            class="col-lg-12 d-flex justify-content-between align-items-start rounded p-3">
                                            <div class="w-max">
                                                <h6 class="text-center text-primary small">Update Profile Image</h6>
                                                <div class="userEditWrapper">
                                                    <img src="assets/images/hackathon/unknown-user.svg"
                                                        alt="dashboard-user" class="img-fluid"/>
                                                    <div class="userEditForm">
                                                        <form action="#" id="editUserPicForm">
                                                            <input type="file" class="d-none" id="editUserPic"/>
                                                            <label for="editUserPic">
                                                                <img src="assets/images/edit-user.svg"
                                                                    alt="userEditForm" width="25"/>
                                                            </label>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                            <a href="#edit" class="btn btn-primary m-0 rounded-pill"><img
                                                    src="assets/images/edit.svg" alt="edit"/> Edit</a>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="floatingInput"
                                                            required="" placeholder="Corporate Name"/>
                                                        <label for="floatingInput"><span><img
                                                                    src="assets/images/user.svg" alt="Banner title"
                                                                    class="img-fluid"/></span> Corporate Name</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 mb-3">
                                                    <div class="form-floating">
                                                        ...
                                                        <label for="floatingInput"><span><img
                                                                    src="assets/images/email.svg" alt="Banner title"
                                                                    class="img-fluid"/></span> Email</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 mb-3">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="floatingInput"
                                                            required="" placeholder="Corporate Mobile Number"/>
                                                        <label for="floatingInput"><span><img
                                                                    src="assets/images/contact.svg" alt="Banner title"
                                                                    class="img-fluid"/></span> Corporate Mobile
                                                            Number</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 mb-3">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="floatingInput"
                                                            required="" placeholder="Corporate Location"/>
                                                        <label for="floatingInput"><span><img
                                                                    src="assets/images/location.svg" alt="Banner title"
                                                                    class="img-fluid"/></span> Corporate Location</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 mb-3">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control"
                                                            placeholder="Corporate User ID" required=""/>
                                                        <label for="floatingInput"><span><img
                                                                    src="assets/images/hackathon/banner-title.svg"
                                                                    alt="Banner title" class="img-fluid"/></span>
                                                            Corporate User ID*</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 mb-3">
                                                    <div class="form-floating pass ">
                                                        ...
                                                        <label for="floatingPassword"><img src="assets/images/email.svg"
                                                                alt="pass" class="img-fluid position-absolute"/> <span
                                                                class="ms-4">Passward</span></label>
                                                        <a href="#icon" class="ms-auto"><img
                                                                src="assets/images/hide-pass.svg" id="Passwordicon"
                                                                class="img-fluid"/></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6  mb-3">
                                                    <div class="form-floating customUploadButton">
                                                        ...
                                                        <label for="formFile"
                                                            class="form-label text-dark text-center mb-0">Upload File
                                                            <br/><span class="small text-secondary text-center">
                                                                Banner Size - 800X400px
                                                            </span></label>
                                                    </div>
                                                    <span class="fs-smaller ms-2 text-secondary"> Supported Formats PNG,
                                                        JPEG and file size max 5mb</span>
                                                </div>
                                                <div class="col-lg-12  mb-3">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <a href="#" type="submit"
                                                                class="btn btn-primary w-100 rounded-pill">Save</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
