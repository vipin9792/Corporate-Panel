...
// import SignupAPI from "./SignupAPI"; // Import SignupAPI
...
const SignupForm = () => {
  ...
  const validationSchema = Yup.object({
    ...
    mytc: Yup.boolean().oneOf([true], "You must accept the Terms & Conditions").required("You must accept the Terms & Conditions"),
  });
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      const response = await SignupAPI(values, BEARER_TOKEN); // Use the API component
