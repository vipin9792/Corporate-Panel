...
const ForgetPassword = () => {
              ...
              {({ handleChange, values }) => (
                ...
                >
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-3">
                      ...
                      <h4 className="text-secondary text-end">Forget <br /> <span className="text-secondary ">Password</span></h4>
                    </div>
  ...
  <div className="form-floating mb-3">
    <Field
      ...
      id="floatingPassword"
      name="password"
      placeholder="\u00A0" // Keeps it visually empty but still functional
      required
    />
    ...
    <ErrorMessage name="password" component="div" className="text-danger" />
        ...
        <div className="col-lg-6 bg-white bg-icons-right">
          ...
          <div className="imageicon1 signupFormIcons">
            ...
            <img src="puzzle.svg" alt="puzzle" width="50px" height="100px" style={{ position: "absolute", left: "87%" }} />
          </div>
