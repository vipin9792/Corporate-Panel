  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log("Transaction Response:", transactionResponse.data); // Log the full response
  
        // Ensure transactions array is populated
        const transactions = transactionResponse.data.transactions;
        console.log("Transactions Array:", transactions); // Log transactions
  
        // Try filtering based on different conditions
        const successfulTransactions = transactions.filter(
          (transaction) => transaction.payment_status === 1 // Change to "paid" or true/false if necessary
        );
        console.log("Filtered Successful Transactions:", successfulTransactions);
