        ...
        var options = {
          ...
          handler: async function (response) {
            ...
            const updatePaymentData = {
              ...
              order_id: orderId,
              reference_id: paymentDetails.receipt, // Use the receipt ID from the API response
              payment_status: 1, // Assuming payment is successful, set status to 1
              amount: paymentDetails.amount / 100, // Convert amount to the correct unit (assuming it's in paise)
            };
