  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      const response = await axios.post(
        ...
        {
          headers: {
            Authorization: `Bearer !WCZVSa3eTg!rE8#0GjAhulUyvOuu!TKB1vz$Y!baEak&u.ZMvikJ3OrjwvcGe91H5@nNY200EkYECpOYRNbu25aipgUGK0Ebi6HuNUDZsV$.MaKIikX6sg!9FaQnJcz`,  // Use the actual token
          },
        }
      );
      ...
      if (response.data.code === 1000) {
        ...
        // Navigate to ViewProfile with userId as part of state
