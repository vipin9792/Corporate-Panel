...
const Dashboard = () => {
  ...
  // Accessing corp_id passed from SignupForm
  const corpId = location.state?.corpId;
  ...
  useEffect(() => {
    ...
    // Fetching profile data using the corp_id
                      ...
                      <div className="col-lg-6">
                        <div className="border rounded-pill p-1 d-flex align-items-center upDashboard">
                          ...
                          <h6 className="ms-2 mb-0 ">
                            <span className="text-primary lh-1">Welcome</span> <br /> {profile?.name || "User TP"}
                            <a href="">
                              <FontAwesomeIcon
                                icon={faSignOutAlt}
                                style={{
