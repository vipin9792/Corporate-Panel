...
const ResetPassword1 = () => {
  ...
  // Replace this with a dynamic approach to get the Bearer token
  const BEARER_TOKEN = localStorage.getItem('bearer_token') || '';  // For example, store the token in local storage
