...
const PlanDetails = () => {
  ...
  const toggleDescription = () => {
    setShowFullDescription((prevState) => !prevState); // Toggle the state for Read More / Less
  };
                  ...
                  {planData && planData.aadhaarValidationContent && (
                    <div className="mt-4" style={{ marginLeft: "182px" }}>
                      ...
                      <p style={{ fontSize: "16px" }}>
                        {showFullDescription
                          ? planData.aadhaarValidationContent
                          : `${planData.aadhaarValidationContent.substring(0, 100)}...`}
                      </p>
                      <Button
                        variant="link"
