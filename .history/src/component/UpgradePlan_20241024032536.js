...
<div className="container text-center my-4">
    <button className={`btn ${isYearly ? 'btn-outline-dark' : 'btn-dark'}`} onClick={() => setIsYearly(false)}>Monthly</button>&nbsp;&nbsp;
    <button className={`btn ${isYearly ? 'btn-dark' : 'btn-outline-dark'}`} onClick={() => setIsYearly(true)}>Yearly</button>
</div>
    ...
    <div className="row text-center">
        {plansData.map(plan => (
            <div className="col-md-4 mb-4" key={plan.name}>
                <div className="card" style={{ background: `rgba(255, 255, 255, 0.9)`, border: "none", color: "#333", transition: "transform 0.3s, box-shadow 0.3s", boxShadow: "0 4px 20px rgba(0, 0, 0, 0.1)" }}>
                    <div className="card-header" style={{ background: "rgba(0, 0, 0, 0.1)" }}>
                        <h3>{plan.name}</h3>
                    </div>
                    ...
                    <div className="card-footer" style={{ background: "rgba(0, 0, 0, 0.1)" }}>
