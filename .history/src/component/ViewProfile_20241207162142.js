    ...
    const fetchProfileData = async () => {
      ...
      try {
        ...
        const response = await axios.post(
          ...
          {
            headers: {
              Authorization: `Bearer !WCZVSa3eTg!rE8#0GjAhulUyvOuu!TKB1vz$Y!baEak&u.ZMvikJ3OrjwvcGe91H5@nNY200EkYECpOYRNbu25aipgUGK0Ebi6HuNUDZsV$.MaKIikX6sg!9FaQnJcz`, // Ensure your token is correct
            },
          }
        );
