...
const SignupForm = () => {
  ...
  const BEARER_TOKEN =
    '!WCZVSa3eTg!rE8#0GjAhulUyvOuu!TKB1vz$Y!baEak&u.ZMvikJ3OrjwvcGe91H5@nNY200EkYECpOYRNbu25aipgUGK0Ebi6HuNUDZsV$.MaKIikX6sg!9FaQnJcz'; // Replace with your actual token

  // Clear localStorage when component mounts
  useEffect(() => {
    localStorage.clear(); // Ensures that no data is stored in localStorage
  }, []);
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      const response = await axios.post(
        'http://103.35.121.219:4000/corp/register', // Replace with actual API endpoint
        values,
        {
          headers: {
      ...
      if (response.status === 200 && response.data.corp_id) {
        ...
        // Redirect to OTP page with corpId as URL parameter
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-10 mx-auto">
                          <div className="form-floating mb-3">
                            ...
                            <label htmlFor="emailId">
                              <img src="email.svg" alt="email" className="img-fluid" /> Email*
                            </label>
                        ...
                        <div className="col-lg-10 mx-auto">
                          <div className="form-floating mb-3">
                            ...
                            <label htmlFor="phoneNo">
                              <img src="contact.svg" alt="contact" className="img-fluid" /> Phone Number*
                            </label>
                        ...
                        <div className="col-lg-10 mx-auto">
                          <div className="form-floating mb-3">
                            ...
                            <label htmlFor="address">
                              <img src="state.svg" alt="state" /> Address*
                            </label>
                        ...
                        <div className="col-lg-10 mx-auto">
                          <div className="form-floating mb-3">
                            ...
                            <label htmlFor="passwd">
                              <img src="password.svg" alt="password" /> Password
                            </label>
                        ...
                        <div className="col-lg-10 mx-auto">
                          <div className="form-floating mb-3">
                            ...
                            />
                            <label htmlFor="name">
                              <img src="name.svg" alt="name" /> Full Name*
                            </label>
                        ...
                        <div className="col-lg-10 mx-auto mt-3">
                          <button type="submit" className="btn btn-primary rounded-pill w-100" disabled={loading}>
