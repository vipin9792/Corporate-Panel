            ...
            <div className="layout-page bg-white">
              ...
              >
                <div className="row">
                  ...
                  >
                    <p className="line-height mt-5">
                      <span class="checkmark ">&#10003;</span> 3-5 days
                      turnaround
                    </p>
                    <p className="line-height">
                      <span class="checkmark ">&#10003;</span> Native
                      Development
                    </p>
                    <p className="line-height">
                      <span class="checkmark ">&#10003;</span> Task Deliveerd
                      One-By-One
                    </p>
                    <p className="line-height">
                      <span class="checkmark ">&#10003;</span> Dedicated
                      Dashboard
                    </p>
                    <p className="line-height">
                      <span class="checkmark ">&#10003;</span> Updates via
                      Dashboard & Slack
                    </p>
                  </div>
