...
const Footer = () => {
  return (
    <div>
       <footer className="footer bg-primary text-white text-center p-3" style={{ background: "#1C4481",position: "absolute", bottom: 0, left: 0, right: 0, borderTop: "1px solid #fff" }}>
