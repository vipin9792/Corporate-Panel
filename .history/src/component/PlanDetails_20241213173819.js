...
const PlanDetails = () => {
  ...
  const handleBuyNow = async () => {
    ...
    try {
      ...
      if (response.data.code === 1000) {
        console.log("API Response (buyPlan):", response.data.status);
        ...
        var options = {
          ...
          modal: {
            ondismiss: function () {
              toast.error("Payment attempt cancelled."); // Error toast
            },
          },
        };
        ...
        setError(response.data.status || "Unknown error");
        toast.error("Error in buying plan.");
      }
    } catch (err) {
      setError("An error occurred while initiating the purchase.");
      toast.error("An error occurred while initiating the purchase.");
      console.error(err);
    } finally {
          ...
          <h6 className="ms-2 mb-0">
           ...
           <FontAwesomeIcon
              ...
              >
                ...
                {/* Logout */}
                <li>
                  <a className="dropdown-item" href="#" onClick={han}>
                    <FontAwesomeIcon
                      icon={faSignOutAlt}
                      className="me-2"
                      style={{ color: "grey" }}
              ...
              <Link to="">
                ...
                {/* Your Plan Details and Other Sections */}
                <section className="hero bg-primary text-white text-center py-5 mt-4">
                  <Container>
                ...
                {/* Your Plan Subscription Details */}
                <section
                  id="plans"
                  style={{ width: "700px", marginLeft: "132px" }}
                >
                  <br />
                  <br />
                  <br />
                ...
                <div className="mt-4">
                  <button
                    ...
                    className="btn btn-primary  btn-lg btn-md ms-2"
