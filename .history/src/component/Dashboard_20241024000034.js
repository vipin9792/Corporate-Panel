        ...
        <div className="row ">
          <div className="col-md-6 col-lg-3 mb-3 ">
            ...
            <ul className="list-unstyled ">
              <li>
                <a href="tel:(010) 1234 4321" className="text-light text-decoration-none">
                  <FontAwesomeIcon icon={faPhone} /> &nbsp;&nbsp;(010) 1234 4321
                </a>
              </li><br />
              <li>
                <FontAwesomeIcon icon={faMapMarkerAlt} />&nbsp;&nbsp; 1 / 105 Bay Lights, Lorem Ipsum, <br />LIC 3201
              </li><br />
            </ul>
           
          </div>
          <div className="col-md-6 col-lg-2 mb-3">
            <h4 className='text-sm text-danger fw-bold'>Page Links</h4>
            <ul className="list-unstyled ">
              <li><a href="#" className="text-light text-decoration-none">Home</a></li>
              <li><a href="#" className="text-light text-decoration-none">About</a></li>
              <li><a href="#" className="text-light text-decoration-none">Testimonial</a></li>
              <li><a href="#" className="text-light text-decoration-none">Blog</a></li>
              <li><a href="#" className="text-light text-decoration-none">Contact</a></li>
            </ul>
          </div>
          <div className="col-md-6 col-lg-3 mb-3">
            <h4 className='text-sm text-danger fw-bold'> More Info</h4>
            <ul className="list-unstyled">
              <li><a href="#" className="text-light text-decoration-none">Lorem ipsum</a></li>
              <li><a href="#" className="text-light text-decoration-none">Dolor sit amet</a></li>
              <li><a href="#" className="text-light text-decoration-none">Consectetur Adipisicing</a></li>
              <li><a href="#" className="text-light text-decoration-none">Ed do eiusmod tempor incididunt</a></li>
            </ul>
          </div>
