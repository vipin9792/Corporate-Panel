                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-10 mx-auto">
                          <div className="form-floating mb-3 position-relative">
                            <Field
                              type={showPassword ? "text" : "password"} // Toggle the type of the input field
                              className="form-control"
                              id="floatingPassword"
                              name="password"
                              placeholder=" "
                            ...
                            <div className="fogot-pass">
                              ...
                              >
                                <img
                                  ...
                                  alt="eye-icon"width="20" style={{marginLeft: "242px",marginTop: "-114px"}}
                            ...
                            <ErrorMessage
                              name="password"
                              component="div"
                              className="error-message" style={{marginTop:"-38px"}}
                            />
                          </div>
                        </div>
