...
<section class="">
        ...
        <div class="col-lg-6 bg-primary text-white bg-icons">
            ...
            <div class="warapper-form my-2">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <Link to="/LoginPage" class="btn-primary rounded-circle goBack">
                        <img src="arrow-left.svg" alt="go back"/>
                    </Link>
                    <h4 class="text-secondary text-end">Create <br/> <span class="text">An Account</span></h4>
                </div>
                <div class="wrapper-inner signupForm overflow-y-scroll overflow-hidden">
                    <form action="index.html" class="bg-white" id="signupForm">
                        <div class="row">
                            <div class="col-lg-10 mx-auto">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="corporateName" placeholder="name@example.com" required/>
                                    <label for="corporateName"><span><img src="name.svg" alt=""/></span> Corporate Name</label>
                                </div>
                            </div>
                            <div class="col-lg-10 mx-auto">
                                <div class="form-floating mb-3">
                            ...
                            <div class="col-lg-10 mx-auto">
                                <div class="form-floating mb-3">
                                    <input type="tel" class="form-control" id="mobileNumber" placeholder="tel" required/>
                                    <label for="mobileNumber"><img src="contact.svg" alt="date" class="img-fluid"/> Corporate Mobile Number*</label>
                                </div>
                            </div>
                            <div class="col-lg-10 mx-auto">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="corporateLocation" placeholder="Uname" required/>
                                    <label for="corporateLocation"><img src="state.svg" alt="user"/> Corporate Location*</label>
                                </div>
                            </div>
                            <div class="col-lg-10 mx-auto">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="userId" placeholder="Uname" required/>
                                    <label for="userId"><img src="user.svg" alt="user"/> Corporate User ID*</label>
                                </div>
                            </div>
                            <div class="col-lg-10 mx-auto">
                                <div class="form-floating mb-3">
                                    <input type="password" class="form-control" id="password" placeholder="Password" required/>
                                    <label for="password"><img src="password.svg" alt=""/> Password</label>
                                </div>
                            </div>
