    ...
    <div className="row text-center">
        {plansData.map(plan => (
            <div className="col-md-4 mb-4" key={plan.name}>
                <div className="card" style={{ background: `rgba(50, 50, 50, 0.85)`, border: "none", color: "white", transition: "transform 0.3s, box-shadow 0.3s", boxShadow: "0 4px 20px rgba(0, 0, 0, 0.3)" }}>
                    <div className="card-header" style={{ background: "rgba(30, 30, 30, 0.9)" }}>
                        <h3>{plan.name}</h3>
                    </div>
                    <div className="card-body" style={{ background: "rgba(70, 70, 70, 0.9)" }}>
                    ...
                    <div className="card-footer" style={{ background: "rgba(100, 100, 100, 0.9)" }}>
                        <Link to="/" className="btn btn-warning">Choose Plan</Link> {/* Changed button color */}
                    </div>
                </div>
            </div>
        ))}
