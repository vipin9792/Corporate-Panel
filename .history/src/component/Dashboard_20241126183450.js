...
const Dashboard = () => {
  // Assume we have the corp_id here, this can come from an API or context
  const corpId = "12345";  // Example corp_id (this can come from props, context, or API response)
  const navigate = useNavigate();

  // Navigate to ViewProfile with corp_id in query parameters
  const handleProfileClick = () => {
    navigate(`/ViewProfile?corpId=${corpId}`);
  };
                  ...
                  <div className="collapse" id="collapseProfile">
                    <ul>
                      <li className="menu-item mt-2">
                        <button onClick={handleProfileClick} className="text-white text-decoration-none">
                      ...
                      <div className=" text-white mt-4" style={{background:"#936963"}}>
                        <div className="row d-flex justify-content-center">
                          <div className="col-12 col-md-8 mt-3">
                            <h2 className="h2 mb-4">Need Support?</h2>
                            <button className="btn btn-lg text-white mb-4" style={{background:"#004d4d"}}>Create Ticket</button>
                          </div>
                        </div>
                      </div>
                    </div>
...
//                     <button type="submit" className="btn btn-danger border-secondary text-bold p-2" style={{ marginTop: "-27px", background: "#1C4481" }}>Assess Assessment Console</button>
