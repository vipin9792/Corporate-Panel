        ...
        <div className="row credential">
          ...
          <div className="col-lg-6 bg-white bg-icons-right">
            ...
            <div className="imageicon1 signupFormIcons">
              ...
              <img src="gradutation-cap.svg" alt="gradutation-cap" style={{marginTop:"222px"}}/>
              <img src="puzzle.svg" alt="puzzle" /> 
            </div>



            <div className="warapper-form-alert carouselWrapper" style={{ marginTop: "65px" }}>
  <div id="carouselExample" className="carousel slide" data-bs-ride="carousel" style={{ width: '350px', margin: 'auto', }}>
