    ...
    <div>
      ...
      <section className="bg-light py-2">
        <Container className="text-center">
          ...
          <ul className="list-unstyled"><span className="fw-b text-success fs-4">Features:</span>
            {planData && planData.features ? (
              planData.features.map((feature) => (
                <li key={feature.id_subscription} className="fs-8 mb-3" style={{fontSize:"6px",textAlign:"justify"}}>
