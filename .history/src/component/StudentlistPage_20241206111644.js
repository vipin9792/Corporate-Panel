                  ...
                  <div className="row">
                    <div className="col-md-4 mb-4 rounded-lg">
                      ...
                      >
                        ...
                        <div className="mb-4 my-2">
                           <Link to={`/ExamListPage/${corp_id}`} className="btn btn-light border-secondary">
                            View Details
                          </Link> 
                        </div>
                      </span>
                    ...
                    <div className="col-md-4 mb-4">
                      ...
                      >
                        ...
                        <div className="mb-4 my-2">
                          <Link to={`/BatchlistPage/${corp_id}`} className="btn btn-light border-secondary">
                            View Details
                          </Link>
                        </div>
                      </a>
                    ...
                    <div className="col-md-4 mb-4">
                      ...
                      >
                        ...
                        <div className="mb-4 my-2">
                          <Link to={`/StudentlistPage/${corp_id}`} className="btn btn-light border-secondary">
                            View Details
                          </Link>
                        </div>
                      </span>
