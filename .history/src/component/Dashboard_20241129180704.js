...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.post(`http://103.35.121.219:4000/corp/dashboard/fetchDetail?corp_id=${corp_id}`);
        
        // Update state with fetched data
        if (response.data.code === 1000) {
          setData(response.data.detail);  // Assuming the API returns a "detail" object with the data
        } else {
  ...
  }, [corp_id]);  // Re-run the effect if `corp_id` changes
                    ...
                    >
                      <div className="card-body d-flex align-items-center justify-content-between">
                        ...
                        <div className="card-data text-start">
                          <span className="fs-2 text-white">{data.batch}</span> {/* Display fetched data */}
                        </div>
                      </div>
                  ...
                  <div className="col-md-4 mb-4">
                    ...
                    >
                      <div className="card-body d-flex align-items-center justify-content-between">
                        ...
                        <div className="card-data text-start">
                          <span className="fs-2 text-white">{data.exam}</span> {/* Display fetched data */}
                        </div>
                      </div>
                      <div className="mb-4 my-2">
                        <button className="btn btn-light border-secondary">
                  ...
                  <div className="col-md-4 mb-4">
                    ...
                    >
                      <div className="card-body d-flex align-items-center justify-content-between">
                        ...
                        <div className="card-data text-start">
                          <span className="fs-2 text-white">{data.student}</span> {/* Display fetched data */}
                        </div>
                      </div>
                      <div className="mb-4 my-2">
                        <button className="btn btn-light border-secondary">
