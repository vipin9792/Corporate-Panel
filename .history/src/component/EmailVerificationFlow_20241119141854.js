...
const EmailVerificationFlow = () => {
  ...
  // Check email and corp_id in localStorage on component mount
  useEffect(() => {
    ...
    if (!storedEmail || !storedCorpId) {
      ...
      console.log("Error: Corp ID or Email is missing!");  // Debugging message
    } else {
  ...
  const handleVerifyOtp = async (e) => {
    ...
    console.log('Verify OTP - Corp ID:', corp_id);  // Debugging: Check the corp_id before API call
