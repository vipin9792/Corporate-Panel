...
const Dashboard = () => {
  ...
  // Add a loading state or a fallback for when the user data is not available
  if (!user) {
                  ...
                  <div className="collapse" id="collapseProfile">
                    <ul>
                      <li className="menu-item mt-2">
                        <Link to={`/ViewProfile/${user.corp_id}`} className="text-white text-decoration-none">
                      ...
                      <div className="col-lg-6">
                        <div className="border rounded-pill p-1 d-flex align-items-center upDashboard">
                          ...
                          <h6 className="ms-2 mb-0">
                            <span className="text-primary lh-1">Welcome</span> <br /> {user.name} {/* Dynamic name from context */}
                            <a href="">
                  ...
                  <div className="col-md-4 mb-4">
                    <span href="batches.html" className="card text-center card-light-yellow" style={{ background: '#d966ff', borderRadius: "22px" }}>
                      <div className="card-body d-flex align-items-center justify-content-between">
                        ...
                        <div className="card-data text-start">
                          <span className="fs-2 text-white">2</span>
                        </div>
                      </div>
                      <div className="mb-4 my-2">
                        <button className="btn btn-light border-secondary">View Details</button>
