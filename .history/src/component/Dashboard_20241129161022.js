...
const Dashboard = () => {
  ...
  useEffect(() => {
    // Fetch the corp data including the corp_id
    axios
      .get("http://103.35.121.219:4000/corp/dashboard/fetchCorpData", {
        headers: {
          Authorization: `Bearer !WCZVSa3eTg!rE8#0GjAhulUyvOuu!TKB1vz$Y!baEak&u.ZMvikJ3OrjwvcGe91H5@nNY200EkYECpOYRNbu25aipgUGK0Ebi6HuNUDZsV$.MaKIikX6sg!9FaQnJcz`,  // Include your token here
        },
      })
      .then((response) => {
        if (response.data.code === 1000) {
          setCorpData(response.data.corp);  // Assuming response includes the corp_id
        }
      })
                            ...
                            <li>
                                ...
                                <div className="collapse" id="collapseProfile">
                                    <ul>
                                        ...
                                        <Link to={`/ViewProfile/${corpData.corp_id}`} className="text-white text-decoration-none">
