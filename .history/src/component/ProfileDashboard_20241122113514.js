...
const ProfileDashboard = () => {
  ...
  const token = 'Bearer !WCZVSa3eTg!rE8#0GjAhulUyvOuu!TKB1vz$Y!baEak&u.ZMvikJ3OrjwvcGe91H5@nNY200EkYECpOYRNbu25aipgUGK0Ebi6HuNUDZsV$.MaKIikX6sg!9FaQnJcz';
    ...
    const fetchData = async () => {
      try {
        ...
        if (err.response && err.response.data.status === 'Token Mismatch or Broken. Relogin to get access.') {
          ...
          // Optionally, you could trigger a logout or redirect to a login page here
        } else {
