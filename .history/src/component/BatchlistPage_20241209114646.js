...
// import { fetchBatches } from "./batchApi"; 
import BatchlistApi { fetchBatches } from "../Api Folder/BatchlistApi"; 
...
const BatchlistPage = () => {
  ...
  useEffect(() => {
    const fetchBatchesData = async () => {
      try {
        setLoading(true);
        const data = await fetchBatches(corp_id); // Use the fetchBatches function
        if (data.code === 1000) {
