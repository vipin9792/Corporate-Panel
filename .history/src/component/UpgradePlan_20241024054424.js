      ...
      <div className="layout-wrapper layout-content-navbar">
        <div className="layout-container">
          ...
          <div className="layout-page bg-white">
            ...
            <div className="hero" style={{ background: "background: "#EDF2FF", borderRadius: "10px" color: "white", padding: "60px 0", textAlign: "center" }}>
...
<div className="container text-center my-4">
    <button 
        className={`btn ${isYearly ? 'btn-light' : 'btn-primary'}`} 
    ...
    <button 
        className={`btn ${isYearly ? 'btn-primary' : 'btn-light'}`} 
