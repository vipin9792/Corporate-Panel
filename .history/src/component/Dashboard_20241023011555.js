        ...
        <div className="layout-page bg-white">
          ...
          <div className="container mt-1">
            ...
            <div className="row">
              ...
              <footer className="bg-primary  h-50 text-center text-white rounded-pill p-3 my-2">SPWID Copyright © 2021 Inferno - All rights reserved || Designed By: Spiwd</footer>
            </div>
