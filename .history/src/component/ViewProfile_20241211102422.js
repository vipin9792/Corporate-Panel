...
const ViewProfile = () => {
  ...
  const [showFileInput, setShowFileInput] = useState(false); // To control file input visibility
  ...
  const updateLogo = async () => {
    ...
    try {
      ...
      if (response.data.code === 1000) {
        ...
        setShowFileInput(false); // Hide file input after uploading
      } else {
                                  ...
                                  <div className="w-max">
                                    <div className="userEditWrapper position-relative">
                                      ...
                                      <div
                                        ...
                                        onClick={() => setShowFileInput(true)} // Show file input when clicked
                                      >
                                        <FontAwesomeIcon
                                          icon={faPen}
                                          style={{
