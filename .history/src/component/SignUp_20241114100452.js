...
const SignUp = () => { const [loading, setLoading] = useState(false);
                        ...
                        <div className="col-lg-10 mx-auto">
                          <div className="form-floating mb-3">
                            <Field
                              ...
                              onBlur={handleBlur}
                            />
                            <label htmlFor="corporateLocation">
                              <img src="state.svg" alt="user" /> Corporate
                              Location*
                            </label>
                            <ErrorMessage
                              name="corporateLocation"
                        ...
                        <div className="col-lg-10 mx-auto">
                          <div className="form-floating mb-3">
                            ...
                            <label htmlFor="userId">
                              <img src="user.svg" alt="user" /> Corporate User
                              ID*
                            </label>
                            <ErrorMessage
                              name="userId"
