      ...
      <section>
        <div className="row credential">
          ...
          <div className="col-lg-6 bg-white bg-icons-right">
            ...
            <div className="warapper-form-alert carouselWrapper" style={{ marginTop: "-20px" }}>
              <div id="carouselExample" className="carousel slide" data-bs-ride="carousel" style={{ height:"200px",width: '300px', margin: 'auto', borderRadius: '24px' }}>
                  ...
                  {carouselData.length > 0 ? (
                    carouselData.map((item, index) => (
                      <div className={`carousel-item ${index === 0 ? 'active' : ''}`} key={item.id}>
                        ...
                        <div className="carousel-content text-center " style={{marginTop:"22px"}}>
                          <h5>{item.photo_text}</h5>
                        </div>
