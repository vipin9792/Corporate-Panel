...
const SignupForm = () => {
  ...
  const [corpId, setCorpId] = useState(null);  // Store corp_id in state
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      if (response.status === 200 && response.data.corp_id) {
        ...
        // Store the corp_id in the component state instead of localStorage
        setCorpId(response.data.corp_id);
        windows.alert("response.data.corp_id")
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-10 mx-auto mt-3">
                          <div className="form-check">
                            <input type="checkbox" className="form-check-input" id="mytc" name="myctc" />
