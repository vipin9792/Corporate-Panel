            ...
            <div class="col-12 transaction-card">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <h3 class="transaction-header text-center">Transaction Details   <br /><span class="transaction-status success">
                        ...
                        <h4 class="text-center transaction-status success">Transaction Successful</h4>
                        <hr/>
</div></div>
</div>
</div>
