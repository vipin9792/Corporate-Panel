...
const PlanDetails = () => {
  ...
  return (
    <>
                  ...
                  <Row className="justify-content-center">
                    {planData && planData.features ? (
                      planData.features.map((feature) => (
                        <Col key={feature.id_subscription} md={4} className="mb-3">
      ...
      <footer className="footer  text-white text-center p-3" style={{ background: "#1C4481",position: "absolute", bottom: 0,top:"100%", left: 0, right: 0, borderTop: "1px solid #fff" }}>
