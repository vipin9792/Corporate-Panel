                    ...
                    <div className="card-body">
                      {loading ? (
                        ...
                        <>
                          ...
                          <p className="card-text">Amount: ₹{activePlan.amount}</p>
                          <p className="card-text">
                            Status:{" "}
                            <span className={activePlan.payment_status === -1 ? "text-warning" : "text-success"}>
                              {activePlan.payment_status === -1 ? "Pending" : "Active"}
                            </span>
                          </p>
                          <Link
                            to={`/TransactionPage/${corp_id}`}
