...
const UpgradePlan = () => {
    ...
    useEffect(() => {
        // Example of API URL, replace with your actual API endpoint
        const apiUrl = 'https://your-api-endpoint.com/corp/subscription/fetchAllPlans';
