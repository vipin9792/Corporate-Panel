...
const PlanDetails = () => {
  ...
  return (
    <>
      ...
      <section id="plans" className="my-2">
        <Container>
      ...
      <section className="bg-light py-2">
        <Container className="text-center">
          ...
          <div className="list-unstyled"><span className="fw-b text-success fs-4 text-center">Features:</span>
            {planData && planData.features ? (
              planData.features.map((feature) => (
                <p key={feature.id_subscription}  style={{fontSize:"16px",textAlign:"center"}}>
