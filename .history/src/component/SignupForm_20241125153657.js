...
const SignupForm = () => {
  ...
  const BEARER_TOKEN = '!WCZVSa3eTg!rE8#0GjAhulUyvOuu!TKB1vz$Y!baEak&u.ZMvikJ3OrjwvcGe91H5@nNY200EkYECpOYRNbu25aipgUGK0Ebi6HuNUDZsV$.MaKIikX6sg!9FaQnJcz'; // Your token here
  ...
  const handleSubmit = async (values) => {
    ...
    // Map form values to match the API's expected keys (e.g., snake_case)
    const requestPayload = {
      company_name: values.companyName, // Using snake_case
      email_id: values.emailId, // Using snake_case
      phone_no: values.phoneNo, // Using snake_case
      address: values.address,
      user_id: values.userid, // Using snake_case
      password: values.passwd, // Using snake_case
      full_name: values.name, // Using snake_case
    };

    try {
      const response = await axios.post(
        'http://103.35.121.219:4000/corp/register', // Ensure this is the correct URL
        requestPayload,
        {
          headers: {
              ...
              <div className="wrapper-inner signupForm overflow-y-scroll overflow-hidden">
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-10 mx-auto">
                          <div className="form-floating mb-3">
                            ...
                            />
                            <label htmlFor="name">
                              <img src="password.svg" alt="" /> Full Name
                            </label>
                            <ErrorMessage
                              name="name"
                              component="div"
                ...
                <div className="d-flex justify-content-between align-items-center mt-2">
                  <p className="text-center">
                    ...
                    <Link to="/LoginForm" className="text-success">
                      Login here
                    </Link>
                  </p>
                </div>
