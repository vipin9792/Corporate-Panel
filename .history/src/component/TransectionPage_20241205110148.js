              ...
              <div className="container h-15vh">
                <section className="hero bg-primary text-white text-center py-5">
                  <Container>
                    ...
                    <p>
                      Subscribe to the plan and enjoy premium services with ease!
                    </p>
                    {planData ? (
                      <div className="card">
                        <div className="card-body">
                          <h5 className="card-title">{planData.plan_name}</h5>
                          <p className="card-text">{planData.plan_description}</p>
                          <Button
                            variant="success"
