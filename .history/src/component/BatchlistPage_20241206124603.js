...
const BatchlistPage = () => {
  ...
  const [batchesPerPage] = useState(15); // Number of batches per page
                        ...
                        {loading ? (
                          ...
                          currentBatches.map((batch, index) => (
                            <tr key={batch.id}>
                              ...
                              <td>
                                {new Date(batch.date_assessment).toLocaleDateString()}
                              </td>
                              <td>
                                {new Date(batch.actual_date_assessment).toLocaleDateString()}
                              </td>
                              <td>{batch.address}</td>
