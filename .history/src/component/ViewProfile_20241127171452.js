...
const ViewProfile = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      if (!corpId) {
        setError('No corpId provided. Redirecting...');
        setLoading(false);
      ...
      {profile && (
        <div className="profile-info">
          ...
          <div className="form-group">
            ...
            {/* Ensure that logo exists, else show a placeholder */}
            <img
              src={profile.logo || '/path/to/placeholder.jpg'}  // Fallback to placeholder
              alt="Company Logo"
              className="img-fluid"
            />
          </div>
