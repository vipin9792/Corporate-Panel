      ...
      <div className="row credential">
        <div className="col-lg-6 bg-primary text-white bg-icons">
          ...
          <div className="wrapper-inner mt-5">
            <Container className="bg-white" style={{width:"400px",padding:"20px",borderRadius:"30px"}}>
              ...
              <Form onSubmit={handleVerifyOtp}>
                ...
                <Button type="submit" className="w-50 mb-1  rounded-pill text-white" disabled={loading}
                 style={{marginLeft:"22px",width:"2o"}}>
