...
const Dashboard = () => {
  // Example of how the corpId could be fetched or passed (you could replace it with actual logic)
  const corpId = 1; // You can replace this with dynamic corp_id if necessary
                  ...
                  <div className="collapse" id="collapseProfile">
                    <ul>
                      <li className="menu-item mt-2">
                        {/* Link updated to include corpId as query parameter */}
