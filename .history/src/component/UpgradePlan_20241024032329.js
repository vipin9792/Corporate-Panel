    ...
    <div className="row text-center">
        {plansData.map(plan => (
            <div className="col-md-4 mb-4" key={plan.name}>
                <div className="card" style={{ background: `linear-gradient(135deg, ${plan.color} 30%, rgba(0, 0, 0, 0.8) 100%)`, border: "none", color: "white", transition: "transform 0.3s, box-shadow 0.3s", boxShadow: "0 4px 20px rgba(0, 0, 0, 0.5)" }}>
                    <div className="card-header" style={{ background: "rgba(0, 0, 0, 0.8)", color: "white", textShadow: "1px 1px 2px black" }}>
                        <h3>{plan.name}</h3>
                    </div>
                    <div className="card-body">
                        ...
                        <h2 className="card-title" style={{ textShadow: "1px 1px 2px black" }}>{isYearly ? plan.yearlyPrice : plan.monthlyPrice}</h2>
                        <p className="card-text" style={{ textShadow: "1px 1px 2px black" }}>Features:</p>
                        <ul className="list-unstyled">
                            {plan.features.map((feature, index) => (
                                <li key={index} style={{ textShadow: "1px 1px 2px black" }}>✔ {feature}</li>
                            ))}
                        </ul>
                    </div>
