      ...
      <section>
        <div>
          <div className="row credential">
            <div className="col-lg-6  text-white bg-icons" style={{ background: "linear-gradient(45deg, #1d57b2, #20478b, #1e52a5)", }}>
              <div className="imageicon">
                <img src="logo1.png" alt="logo" id="logo" style={{ mixBlendMode: "luminosity",opacity:"0.7",color:"white"}} />
