          ...
          <div className="container h-15vh">
            <div className="row mt-3 align-items-center">
              <div className="col-lg-8">
                <h4 className="fw-bold text-">Dashborad/Corporate Profile</h4>
              </div>
                                ...
                                <div class=" bg-white">
                                    <div class="row m-1">
                                        <div
                                            ...
                                            <div class="w-max">
                                                <h6 class="text-center text-grey small">Update Profile Image</h6>
                                            ...
                                            <a href="#edit" class="btn btn-primary m-0 rounded-pill text-white"><img
                                                    src="edit.svg" alt="edit"/> Edit</a>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    <div class="form-floating">
                                                        ...
                                                        <label for="floatingInput"><span><img
                                                                    src="email.svg" alt="Banner title"
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    <div class="form-floating">
                                                        ...
                                                        <label for="floatingInput"><span><img
                                                                    src="contact.svg" alt="Banner title"
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    <div class="form-floating">
                                                        ...
                                                        <label for="floatingInput"><span><img
                                                                    src="location.svg" alt="Banner title"
                                                ...
                                                <div class="col-lg-12  mb-3">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <a href="#" type="submit"
                                                                class="btn btn-primary w-100 rounded-pill text-white">Save</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
