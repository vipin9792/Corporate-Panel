  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      ...
      const response = await axios.post(
        ...
        {
          headers: {
            Authorization: `Bearer !WCZVSa3eTg!rE8#0GjAhulUyvOuu!TKB1vz$Y!baEak&u.ZMvikJ3OrjwvcGe91H5@nNY200EkYECpOYRNbu25aipgUGK0Ebi6HuNUDZsV$.MaKIikX6sg!9FaQnJcz`, // Your token here
          },
        }
      );
      ...
      if (response.data.code === 1000) {
        ...
        // Store the userId in local storage for future use
        const userId = response.data.profile.id;
        localStorage.setItem('userId', userId); // Store userId to fetch profile later

        // Redirect to the Profile page (after successful login)
        navigate('/ViewProfile'); // Assuming '/Profile' is the route for the profile page
      } else {
            ...
            <div className="col-lg-6 bg-primary text-white bg-icons">
              ...
              <div className="warapper-form">
                <div className="d-flex align-items-center justify-content-between mb-3">
                  <Link to="/SignupForm" className="btn-primary rounded-circle goBack">
