...
const ViewProfilePage = () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setInitialValues({
          ...
          passwd: response.data.passwd || "",  // Assuming password is not needed to be shown
  ...
  // Handle form submission (even though the fields are readonly, this can be used to update profile data)
  ...
  // Wait until profile data is fetched before rendering the form
  if (loading) {
              ...
              {error ? (
                ...
                <div className="wrapper-inner signupForm overflow-y-scroll overflow-hidden">
                  <Formik
                    ...
                    enableReinitialize  // This makes sure initialValues are updated after fetching data
                  >
