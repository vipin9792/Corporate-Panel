...
import { forgetPassword } from './api';  // Import the API function
...
const ForgetPassword1 = () => {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      const response = await forgetPassword(email);  // Use the API function
            ...
            <div className="col-lg-6 bg-primary text-white bg-icons">
              ...
              <div className="warapper-form">
                <div className="d-flex align-items-center justify-content-between mb-3">
                  <h4 className="text-secondary" style={{ marginLeft: "230px" }}>Forget <br /> <span className="text">Password</span></h4>
                </div>
