...
const Signup = () => {
  const validationSchema = Yup.object({
    ...
    mobileNumber: Yup.string().required('Mobile Number is required').matches(/^[0-9]+$/, 'Must be a number'),
  ...
  return (
    <section>
      <style>{`
        ...
        .signupForm {
          max-height: 100%; /* Ensure form does not exceed the container */
          overflow-y: auto; /* Enable vertical scrolling on the form only */
        }
      `}</style>
