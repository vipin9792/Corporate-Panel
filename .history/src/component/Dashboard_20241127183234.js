...
const Dashboard = () => {
    // Replace this with actual logic to retrieve corp_id
    const corp_id = "12345"; // Example corp_id, replace it with the actual value you have
                                ...
                                <div className="row">
                                    <div className="col-md-12 mb-3">
                                        <div className="card text-center" style={{ background: "#936963" }}>
                                            ...
                                            <div className="card-body" style={{ background: "#f7e0e0" }}>
                                                <div className="row justify-content-between">
                                                    <div className="col-lg-7 col-sm-12 mt-2">
                                                        <p className="text-dark">All Hackathons and Tasks can be managed from here.</p>
                                                    </div>
                                                    <div className="col-lg-4 col-sm-12 mt-2">
                                                        <Link to="/Tasks" className="btn btn-primary">Manage Hackathon</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
