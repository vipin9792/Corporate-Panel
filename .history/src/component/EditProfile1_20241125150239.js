...
const EditProfile1 = () => {
  ...
  useEffect(() => {
    const fetchProfileData = async () => {
      try {
        const corpId = localStorage.getItem('corp_id'); // Ensure you have access to corp_id
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        'http://103.35.121.219:4000/corp/dashboard/fetchProfile', // Replace with your correct API endpoint
        formData,
        {
          headers: {
  ...
  return (
    <div className="container mt-4">
      ...
      <form onSubmit={handleFormSubmit}>
        ...
        <div className="row mb-3">
          <div className="col-md-6">
            <label htmlFor="phone_no" className="form-label">Corporate Mobile Number</label>
            <input
              type="text"
              id="phone_no"
              name="phone_no"
          ...
          <div className="col-md-6">
            <label htmlFor="address" className="form-label">Corporate Location</label>
            <input
              type="text"
              id="address"
              name="address"
        ...
        <div className="row mb-3">
          <div className="col-md-6">
            <label htmlFor="logo" className="form-label">Corporate Logo</label>
            <input
              type="file"
              id="logo"
              name="logo"
