          ...
          <div className="layout-container" style={{ position: "relative" }}>
            ...
            <div className="layout-page bg-white">
                      ...
                      <Card className="shadow-sm mb-4 rounded-3">
                        <Card.Body className="text-center">
                          <Card.Title className="fs-1">
                            <p style={{fontSize:"24px",fontWeight:"bold"}}> {planData ? planData.plan_name : "0"}</p>
                          </Card.Title>
              ...
              <div className="mt-4" style={{position:"absolute",left:"60%",top:"50%"}}>
                                        <button className="btn btn-primary btn-sm">Subscription Plan</button>
                                        <button className="btn btn-success btn-sm ms-2">Buy Now</button>
                                    </div>
