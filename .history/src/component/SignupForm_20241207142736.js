...
const SignupForm = () => {
  ...
  const initialValues = {
    ...
    passwd: '',
    name: '',
    mytc: false,  // Tracks the checkbox
  };
...
const handleCheckboxChange = (event, setFieldValue) => {
  ...
  setFieldValue('mytc', isChecked);  // Update Formik state for the checkbox
  setCheckboxChecked(isChecked);  // Update local state to track checkbox
};
...
<div className="col-lg-10 mx-auto">
  <div className="form-floating mb-3">
    <Field
      ...
      pattern="[0-9]{10}" // Only allow digits
    />
    <label htmlFor="phoneNo">
      <img
        src="contact.svg"
    ...
    />
                          ...
                          <div className="form-floating mb-3">
                            ...
                            >
                              <img
                                ...
                                style={{position:"absolute",marginLeft: "222px",marginTop: "-45px",width:"20px",height:"20px"}}
                              />
                            </span>
                          </div>
                        </div>
              ...
              <div className="form-check">
                <Field
                  ...
                  name="mytc"
                  checked={values.mytc}
                  onChange={(event) => handleCheckboxChange(event, setFieldValue)}  {/* pass setFieldValue */}
                />
            ...
            <div className="col-lg-10 mx-auto mt-3">
              <button
                ...
                style={{ cursor: checkboxChecked ? 'pointer' : 'not-allowed' }}
              >
