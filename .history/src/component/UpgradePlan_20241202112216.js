            ...
            <div className="d-flex flex-column min-vh-100 position-relative">
                <div className="layout-wrapper layout-content-navbar flex-grow-1">
                                        ...
                                        plansData.map((plan, index) => {
                                            ...
                                            return (
                                                <div key={index} className="col-lg-4 mb-2">
                                                    <div className="card shadow-sm" style={{ height: "1000px" }}>
                  ...
                  {plan.features.map((feature) => (
                    <div >
                    <li key={feature.id_subscription} style={{textAlign:"left",width:"300px" ,padding:"2px",marginLeft:"20px"}}>
                      {feature.subscription_display_name}
                    </li>
                    </div>
                  ))}
                </ul>
<hr  style={{textAlign:"left",width:"300px" ,padding:"2px",marginLeft:"20px"}}/>
