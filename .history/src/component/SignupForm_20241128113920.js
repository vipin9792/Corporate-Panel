...
import { useCorpId } from "../contexts/CorpIdContext"; // Importing the context

import Slider from "./Slider";

const SignupForm = () => {
  const { setCorpId } = useCorpId();  // Using the context function to set corp_id globally
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-10 mx-auto">
                          <div className="form-floating mb-3">
                            ...
                            />
                            <label htmlFor="name">
                              <img src="user.svg" alt="user" /> Full Name*
                            </label>
                            <ErrorMessage
                              name="name"
                              component="div"
