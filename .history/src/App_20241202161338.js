...
{/* Route for the UpgradePlan component */}
<Route path="/UpgradePlan/:corp_id/:plan_ref" element={<UpgradePlan />} />

{/* Route for the PlanDetails component, passing corp_id and plan_ref */}
<Route path="/plan-details/:corp_id/:plan_ref/" element={<PlanDetails />} />
