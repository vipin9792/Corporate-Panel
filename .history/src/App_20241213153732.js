...
{/* Protected Routes */}
<Route path="/Dashboard/:corp_id" element={<PrivateRoute element={Dashboard} />} />
        <Route path="/ViewProfile/:corp_id" element={<PrivateRoute element={ViewProfile} />} />
        <Route path="/EditProfile1/:corp_id" element={<PrivateRoute element={EditProfile1} />} />
        <Route path="/UpgradePlan/:corp_id" element={<PrivateRoute element={UpgradePlan} />} />
