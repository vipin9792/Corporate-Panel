...
{/* Protected Routes */}
<PrivateRoute path="/Dashboard/:corp_id" element={<Dashboard />} />
        <PrivateRoute path="/ViewProfile/:corp_id" element={<ViewProfile />} />
        <PrivateRoute path="/EditProfile1/:corp_id" element={<EditProfile1 />} />
        <PrivateRoute path="/UpgradePlan/:corp_id" element={<UpgradePlan />} />
