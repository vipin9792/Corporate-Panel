...
const App = () => {
  ...
  const handleLogin = (corpId) => {
    setIsAuthenticated(true); // User is logged in
    // You can store `corpId` in state or elsewhere as needed
  };
    ...
    <Router>
      ...
      <Route path="/" element={<LoginForm onLogin={handleLogin} />} />
        ...
        <Route
          ...
          element={isAuthenticated ? <Dashboard onLogout={handleLogout} /> : <Navigate to="/Dashboard/:corp_id" />}
        />

<Route
          path="/ViewProfile/:corp_id"
          element={isAuthenticated ? <ViewProfile onLogout={handleLogout} /> : <Navigate to="/" />}
        />
